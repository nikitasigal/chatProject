...
void clientRequest_LoadMessages(SOCKET serverSocket, FullDialogInfo dialogInfo) {
    ...
    if (bytes < 0)
        printf("ERROR, file - 'clientCommands.c', foo - 'clientRequest_LoadMessages': Can't send request for loading messages. Sent 0 bytes of information\n");
}
...
void clientRequest_CreateDialog(SOCKET serverSocket, FullDialogInfo dialogInfo) {
    ...
    int bytes = send(serverSocket, (void *) &dialogInfo, sizeof(FullDialogInfo), 0);
    if (bytes < 0)
        printf("ERROR, file - 'clientCommands.c', foo - 'clientRequest_SendMessage': Can't create a dialog. Sent 0 bytes of information\n");
}
...
void clientRequest_SendMessage(SOCKET serverSocket, FullMessageInfo messageInfo) {
    ...
    if (bytes < 0)
        printf("ERROR, file - 'clientCommands.c', foo - 'clientRequest_SendMessage': Can't get a message. Sent 0 bytes of information\n");
}
...
void clientRequest_Registration(SOCKET serverSocket, FullUserInfo userInfo) {
    ...
    if (bytes < 0)
        printf("ERROR, file - 'clientCommands.c', foo - 'clientRequest_Registration': Registration failed. Sent 0 bytes of information\n");
}
...
void clientRequest_Authorization(SOCKET serverSocket, FullUserInfo userInfo) {
    ...
    int bytes = send(serverSocket, (void *) &userInfo, sizeof(FullUserInfo), 0);
    if (bytes < 0)
        printf("ERROR, file - 'clientCommands.c', foo - 'clientRequest_Authorization': Authorization failed. Sent 0 bytes of information\n");
}
...
void clientRequest_SendFriendRequest(SOCKET serverSocket, FullUserInfo userInfo) {
    ...
    int bytes = send(serverSocket, (void *) &userInfo, sizeof(FullUserInfo), 0);
    if (bytes < 0)
        printf("ERROR, file - 'clientCommands.c', foo - 'clientRequest_SendFriendRequest': Can't send friend request. Sent 0 bytes of information\n");
}
...
void clientRequest_FriendRequestDeclined(SOCKET serverSocket, FullUserInfo userInfo) {
    ...
    int bytes = send(serverSocket, (void *) &userInfo, sizeof(FullUserInfo), 0);
    if (bytes < 0)
        printf("ERROR, file - 'clientCommands.c', foo - 'clientRequest_FriendRequestDeclined': Can't decline a friend request. Sent 0 bytes of information\n");
}
...
void clientRequest_RemoveFriend(SOCKET serverSocket, FullUserInfo userInfo) {
    ...
    int bytes = send(serverSocket, (void *) &userInfo, sizeof(FullUserInfo), 0);
    if (bytes < 0)
        printf("ERROR, file - 'clientCommands.c', foo - 'clientRequest_RemoveFriend': Can't remove friend. Sent 0 bytes of information\n");
}
...
void clientRequest_LeaveDialog(SOCKET serverSocket, FullUserInfo userInfo) {
    ...
    int bytes = send(serverSocket, (void *) &userInfo, sizeof(FullUserInfo), 0);
    if (bytes < 0)
        printf("ERROR, file - 'clientCommands.c', foo - 'clientRequest_LeaveDialog': Can't leave dialog. Sent 0 bytes of information\n");
}